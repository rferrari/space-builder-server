...
- **Size**: w,h in grid units (minimum 3x2)
- **Constraints**: 
  - x + w ≤ 12 (cannot exceed grid width)
  - y + h ≤ 10 (cannot exceed grid height)
  - No overlapping items
  - Minimum sizes per fidget type (text: 3w×2h, feed: 4w×2h, etc.)
  - **CRITICAL**: All fidgets must fit within the 10-row limit
...
MANDATORY: Ensure the full 12×10 grid is filled with fidgets using these precise layout placements.
