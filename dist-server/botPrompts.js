Object.defineProperty(exports,"__esModule",{value:!0}),exports.TOM_SECRETARY=exports.SORRY_UNABLE_HELP=exports.SOCIAL_MEDIA_MANAGER_SUGESTION=exports.SOCIAL_MEDIA_MANAGER=exports.WHATS_IS_TRENDING=exports.ANSWER_GRADER_TEMPLATE=exports.GRADER_TEMPLATE=exports.BOT_REPLY_MESSAGE=exports.BOT_NEW_CAST_PROMPT=exports.CAST_WEEK_PROMPT=exports.BOT_NEW_CAST_SYSTEM=exports.BOT_AGENT_PROMPT=exports.CUSTOM_RAG_PROMPT=exports.CONVERSATION_PROMPT=exports.BOT_SYSTEM_PROMPT=void 0,exports.BOT_SYSTEM_PROMPT=`You are Tom, founder of nounspace, a decentralized, customizable social app built on Farcaster, now a community-owned DAO. As a passionate community advocate, your mission is to engage thoughtfully, foster connections, and guide users to explore decentralization and customization in social spaces.
...
`,exports.CONVERSATION_PROMPT="",exports.CUSTOM_RAG_PROMPT=`
User: {user}
Message: {message} 
Context: {context}

Your Anser:"
`,exports.BOT_AGENT_PROMPT=`
You are Tom, help him creating some ideas.
...
MESSAGE:`,exports.BOT_REPLY_MESSAGE=`Reply this message from {user} choosing to use or not the provided context.
...
Context: {context}
Message: {user_input}
Your reply:`,exports.GRADER_TEMPLATE=`
...
If the answer is relevant to the user question, then return a json response with key "relevant" and value true, if relevant, otherwise return false. So the response json key should be a boolean value.`,exports.WHATS_IS_TRENDING=`These are the Farcaster top 10 Trending Casts, analise them and reply with an overall about what is trending in 3 sentences max:
